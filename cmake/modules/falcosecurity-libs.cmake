...
if(FALCOSECURITY_LIBS_SOURCE_DIR)
  ...
  if(NOT FALCOSECURITY_LIBS_VERSION)
    set(FALCOSECURITY_LIBS_VERSION "6cad197334632f8d76529ddd4130cf97990baeb2")
  ...
  # Patch sources if needed for zig compiler
  if (ENABLE_ZIG_WORKAROUNDS)
    add_subdirectory(${CMAKE_CURRENT_SOURCE_DIR}/cmake/modules/falcosecurity-libs-repo/patches)
  endif()
endif()
